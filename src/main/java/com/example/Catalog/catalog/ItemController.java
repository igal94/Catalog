...
public class ItemController {
    ...
    public Item getItem(@PathVariable String number) {
        return itemService.getItem(number);
    }

    @PutMapping("/items/{number}/w/{quantity}")
    ...
    public Item withdrawalItem(@PathVariable String number, @PathVariable String quantity) {
        ...
        return itemService.updateItem(number, item);
    }

    @PutMapping("/items/{number}/d/{quantity}")
    ...
    public Item depositItem(@PathVariable String number, @PathVariable String quantity) {
        Item item = itemService.getItem(number);
        String currQuantity = item.getAmount() ;
    ...
    public Item deleteItem(@PathVariable("number") String no) {
